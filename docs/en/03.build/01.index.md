...
1. If you want to open the *nymea*-project wit the Qt Creator (`SDK`), you have to install the needed packages either from the official repository of your distribution:
        ...
        $ sudo apt-get install build-essential qt5-default qtcreator git ccache
...
You can proceed with the [Getting-Started](/documentation/nymea/master/getting-started) instructions.
