...
2. Mount the partition and unzip the latest [guh-netinstall.zip](http://jenkins.guh.guru/job/build-raspbian-netinstall/lastSuccessfulBuild/artifact/guh-netinstall-v1.0.7.zip) file on it.
...
Download the latest latest [guh-netinstall.zip](http://jenkins.guh.guru/job/build-raspbian-netinstall/lastSuccessfulBuild/artifact/guh-netinstall-v1.0.7.zip) file:

    $ sudo wget http://jenkins.guh.guru/job/build-raspbian-netinstall/lastSuccessfulBuild/artifact/guh-netinstall-v1.0.7.zip
...
4. Unzip the latest [guh-netinstall.zip](http://jenkins.guh.guru/job/build-raspbian-netinstall/lastSuccessfulBuild/artifact/guh-netinstall-v1.0.7.zip) to the BOOT partition on the SD card:
...
> **Note:** because avahi-daemon is running by default and the webinterface should already running you can also open following link [http://guh.local:3333](http://guh.local:3333)
