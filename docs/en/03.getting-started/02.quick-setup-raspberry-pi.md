...
<dl>
<img src="https://raw.githubusercontent.com/guh/nymea-wiki/master/docs/en/images/cloud-box-settings.JPG" alt="Cloud screenshot" style="float: left; font-size: 9pt; text-align: center; width: 23%; margin-right: 1%; margin-bottom: 0.5em;">
<img src="https://raw.githubusercontent.com/guh/nymea-wiki/master/docs/en/images/cloud-app-settings.jpg" alt="Cloud screenshot" style="float: left; font-size: 9pt; text-align: center; width: 23%; margin-right: 1%; margin-bottom: 0.5em;">
</dl>
<br /> 
