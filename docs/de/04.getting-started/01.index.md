...
If you want nymead to load plugins from a custom directory, like a build directory of a nymea plugin, one can add the path to the environment variable like f$
